...
# create letter using starting_letter.txt
with open(TEMPLATE_PATH) as template:
    letter = template.read()

# for each name in invited_names.txt, replace [name] placeholder with the actual name
...
for name in names_list:
    # save letters in the output folder
